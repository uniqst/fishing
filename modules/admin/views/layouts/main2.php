...
<div class="container">
   <div class="btn-group btn-group-justified">
       <a href="<?=Url::to(['/site/logout'])?>" class="btn btn-danger btn-lg"><?=\Yii::$app->user->identity->username;?> | (Выйти)</a>
        ...
        <a href="<?=Url::to(['pages/index'])?>" class="btn btn-danger btn-lg">Страницы</a>
         <a href="<?=Url::to(['options/update', 'id' => 1])?>" class="btn btn-danger btn-lg">Настройки</a>
       </div>
<?=$content?>
</div>
<?php $this->endBody() ?>
